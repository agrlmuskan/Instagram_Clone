...
function Number_of_Followers(data) {
    document.getElementById(1).innerHTML = 2;
}

function Number_of_Followings(data) {
    document.getElementById(2).innerHTML = 4;
}

function Number_of_Suggestions(data) {
    document.getElementById(3).innerHTML = 6;
}
